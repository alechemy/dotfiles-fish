// New Note → DEVONthink Archive
//
// Sends the draft to the DEVONthink "99_ARCHIVE" group as a Markdown
// record. Decides whether the first line is a sensible title:
...
const ARCHIVE_GROUP_UUID = "6B07BF0B-4DFE-44E7-A044-663C7FD0D212";
...
(() => {
  ...
  cb.addParameter("destination", ARCHIVE_GROUP_UUID);
