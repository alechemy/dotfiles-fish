...
function setup_gitconfig
  ...
  if test -z (git config --global --get user.email)
    ...
    test -n $user_name
      or echo "Please enter your git author name"
    test -n $user_email
      or abort "Please enter your git author email"
  ...
  # finally alert git that this is a managed config already, preventing later
...
test (which fish) = $SHELL
  and success '^ fish is already set as our default shell. great!'
