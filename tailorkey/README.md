...
Eight tweaks layered on stock TailorKey. The unmodified reference sits at `upstream/Glove80 TailorKey v5.2³ Bilateral - macOS.json` so this inventory can be regenerated by diff.
...
Net combo count: 13 (upstream's 11 + Tweak 3's Hyper + Tweak 6's Shyper + Tweak 7's MCLK + Tweak 8's second Hyper − Tweak 5's removed Meh − Tweak 8's removed right caps-word).
